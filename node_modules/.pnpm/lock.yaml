...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.8.tgz':
    resolution: {integrity: sha512-TYZ362IXo9geeorS5sufEoQGox1fbDj7R3EYLwH8huHcZB5PD9JcgWVC5iVAmEojNjSEuPxRvLWm4cGdhRvdeA==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.8.tgz}
    version: 2.7.8
    bundledDependencies:
      - '@oai/walnut'
      - skia-canvas
